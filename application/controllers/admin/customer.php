...
class Customer extends CI_Controller {
    ...
    public function index() {
        $data['customer_data'] = $this->user->getUserRecords('vendor');
        $data['page_name'] = 'Vendor Manage';
        $data['breadcum'] = 'Manage Vendor';
        $this->load->view($this->config->item('adminFolder') . '/header', $data);
        $this->load->view($this->config->item('adminFolder') . '/user/customer_list');
