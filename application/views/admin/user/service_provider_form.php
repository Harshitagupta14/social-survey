<ul class="breadcrumb">
    ...
    <li class="active"><?php echo isset($admin_id) ? $breadcum_edit : $breadcum ?></li> 
</ul>
            ...
            <form action="" class="form-horizontal" method="post" enctype="multipart/form-data">                 
                <div class="panel panel-default">
                    <div class="panel-heading">                       
                        <h3 class="panel-title"><?php if($admin_id){ ?>Edit<?php } else { ?> Add<?php } ?> Admin</h3>
                        <ul class="panel-controls">
                            <li><a href="<?php echo site_url()?>admin/admin-list"><span class="fa fa-backward" title="Back"></span></a></li>
                        </ul>
                    </div>
