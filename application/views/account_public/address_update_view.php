					...
					<fieldset>
						...
						<ul>
							<li>
								...
								<input type="text" id="landmark" name="update_landmark" value="<?php echo set_value('update_landmark',$address['uadd_landmark']);?>"/>
							</li>
							<li class="info_req">
								<label for="address_01">Address:</label>
								<input type="text" id="address_01" name="update_address" value="<?php echo set_value('update_address',$address['uadd_address']);?>"/>
							</li>
							<li class="info_req">
