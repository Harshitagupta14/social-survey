        ...
        <div class="row">
            <div class="col-md-8 page-content">
                <div class="inner-box category-content">
                    <h2 class="title-2"><i class="icon-user-add"></i> Create service provider account, Its free </h2>
                    <div class="row">
                        <div class="col-sm-12">
                            <form action="<?= site_url('account-service-provider') ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
                                <fieldset>
                                    <div class="form-group required">
                                        ...
                                        <div class="col-md-6">
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="customer_type" id="job-finder" value="service_provider" checked>
                                    ...
                                    <div class="form-group required forJobFinder">
                                        <label class="col-md-4 control-label">Company Name <sup>*</sup></label>
                                        <div class="col-md-6">
                                            <input name="register_company_name" value="<?php echo set_value('register_company_name'); ?>" placeholder="Company Name" class="form-control input-md"  type="text">
                                            <span class="help-block" style="color: red;"><?= strip_tags(form_error('register_company_name')) ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group forJobFinder required">
                                        <label class="col-md-4 control-label" for="textareaFinder">About Your Company <sup>*</sup></label>
                                        <div class="col-md-6">
                                            <textarea class="form-control" id="textareaFinder" name="register_company_detail" placholder="About Your Company"><?php echo set_value('register_company_detail'); ?></textarea>                                      <span class="help-block" style="color: red;"><?= strip_tags(form_error('register_company_detail')) ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group forJobFinder required">
                                        <label class="col-md-4 control-label">Upload Aadhar Photo<sup>*</sup></label>
                                        <div class="col-md-6">
